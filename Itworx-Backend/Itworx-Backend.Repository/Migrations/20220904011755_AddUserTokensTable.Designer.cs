...
namespace Itworx_Backend.Repository.Migrations
{
    ...
    [Migration("20220904011755_AddUserTokensTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Itworx_Backend.Domain.Entities.ImageFile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Itworx_Backend.Domain.Entities.userToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Itworx_Backend.Domain.Entities.userToken", b =>
                {
                    b.HasOne("Itworx_Backend.Domain.Entities.User", "user")
                        .WithOne("UserToken")
                        .HasForeignKey("Itworx_Backend.Domain.Entities.userToken", "userid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
